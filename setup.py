...
setup(
    ...
    entry_points={'console_scripts':
                  '\n'.join([
                      ...
                      'collect-exports=pyflyby.bin.collect_exports:main',
                      'collect-imports=pyflyby.bin.collect_imports:main',
                      'list-bad-xrefs=pyflyby.bin.list_bad_xrefs:main',
                      'prune-broken-imports=pyflyby.bin.prune_broken_imports:main',
                      'pyflyby-diff=pyflyby.bin.pyflyby_diff:main',
                      'reformat-imports=pyflyby.bin.reformat_imports:main',
                      'replace-star-imports=pyflyby.bin.replace_star_imports:main',
                      'tidy-imports=pyflyby.bin.tidy_imports:main',
                      'transform-imports=pyflyby.bin.transform_imports:main',
                  ])},
    data_files=[
        ('libexec/pyflyby', [
