...
from   numpy                    import (Inf, NAN, NaN, abs as aabs, absolute,
                                        ...
                                        double, dsplit, dstack, dtype, e,
                                        ediff1d, emath, empty, empty_like,
                                        ...
                                        lib, linalg, linspace, little_endian,
                                        ...
                                        sort_complex, source, spacing, split,
                                        sqrt, square, squeeze, std, str_,
                                        string0, string_, subtract, sum,
                                        swapaxes, take, tan, tanh, tensordot,
                                        testing, tile, trace, transpose, trapz,
                                        tri, tril, tril_indices,
                                        tril_indices_from, trim_zeros, triu,
                                        triu_indices, triu_indices_from,
                                        true_divide, trunc, ubyte, ufunc, uint,
                                        uint0, uint16, uint32, uint64, uint8,
                                        uintc, uintp, ulonglong, unicode,
                                        unicode0, unicode_, union1d, unique,
