...
from   pyflyby.file             import Filename, expand_py_files_from_args
from   pyflyby.idents           import dotted_prefixes
from   pyflyby.importclns       import ImportMap, ImportSet
from   pyflyby.importstmt       import Import, ImportStatement
from   pyflyby.log              import logger
from   pyflyby.parse            import PythonBlock
from   pyflyby.util             import cached_attribute, memoize, stable_unique
...
class ImportDB(object):
    ...
    def get_default(cls, target_filename):
        ...
        @param target_filename:
          The target filename for which to get the import database.  The target
