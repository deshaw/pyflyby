...
Only top-level import statements are tidied by default. Use
--tidy-local-imports to also tidy imports within function and class bodies.
...
def _addopts(parser):
    ...
    parser.add_option('--transform-strings', dest='transform_strings',
                        default=False, action='store_true',
                        help=hfmt('''
                            When using --transform, also replace matches inside
                            string literals (including docstrings and f-string
                            text).  Off by default.'''))
    parser.add_option('--no-transform-strings', dest='transform_strings',
                        action='store_false',
                        help=hfmt('''
                            (Default) Don't replace matches inside string
                            literals when using --transform.'''))
    ...
    parser.add_option('--no-add', action='callback',
                        ...
                        help=hfmt('''
                            ...
                            --no-add-mandatory.'''))
    parser.add_option('--tidy-local-imports', dest='tidy_local_imports',
                        default=False, action='store_true',
                        help=hfmt('''
                            Also tidy imports within function and class
                            bodies (removing unused local imports).
                            Disabled by default.'''))
